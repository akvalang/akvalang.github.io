...
<div class="login">
    <div class="logo"></div>
    <div class="top">
        <span class="formName">Login</span>
    ...
    <a href="http://uniseven.com.ua/remindpass" class="remind">Remind</a>
    <button type="submit" class="button" value="Login">Login</button>
</div>
<a href="http://uniseven.com.ua/registration">
    <div class="newAccount">
        <span class="createAcc">Create an account</span>
    </div>
</a>
</body>
</html>