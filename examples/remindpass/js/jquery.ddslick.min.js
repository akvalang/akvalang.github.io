/**
 * Created by nastya.done on 18.12.15.
 */
(function (e) {
    console.log("ololo");
    ...
    }, i = '<div class="dd-select">' +
        '<input class="dd-selected-value" type="hidden" />' +
        '<a class="dd-selected"></a>' +
        '<span class= "dd-pointer"></span>' +
        '</div>', a = '<ul class="dd-options"></ul>', b = '<style id="css-ddslick" type="text/css" src="css/style.css">​</style>';
        c.init = function (l) {
        var l = e.extend({}, d, l);
        ...
        return this.each(function () {
            ...
            if (!q) {
                ...
                e.each(l.data, function (v, w) {
                    ...
                    u.append('<li><a class="dd-option">' + (w.value ? ' <input class="dd-option-value" type="hidden" value="' + w.value + '" />' : "") + (w.imageSrc ? ' <img class="dd-option-image' + (l.imagePosition == "right" ? " dd-image-right" : "") + '" src="' + w.imageSrc + '" />' : "") + (w.text ? ' <label class="dd-option-text">' + w.text + "</label>" : "")  + "</a></li>")
                });
    ...
    function f(p) {
        ...
        if (n) {
            ...
            e(".dd-select").css("opacity", "1")
        } else {
            m.slideDown("fast");
            l.addClass("dd-pointer-up")
            e(".dd-select").css("opacity", "0.7")
        }
        h(p)
    }
