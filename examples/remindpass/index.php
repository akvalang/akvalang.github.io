...
<head>
    ...
    <title>Remindpass</title>
</head>
<body>
<div class="login">
    <div class="logo"></div>
    <div class="top">
        <span class="formName">Remind password</span>
...
<!--    <a  class="back" href="http://uniseven.com.ua/login"><img src="img/back.svg">Back to login</a>-->
    <div class="bott">
    <p class="text">Enter your email address to receive temporary password.</p>
    <img src="img/loginIcon.svg" class="icon">
    <input type="email" name="Email" class="email" placeholder="Email" required>
    <button type="submit" class="button" value="Send me password">Send me password</button>
        </div>
</div>
<a href="http://uniseven.com.ua/login">
    <div class="newAccount">
        <span class="createAcc">Back to login</span>
    </div>
</a>
</body>
</html>