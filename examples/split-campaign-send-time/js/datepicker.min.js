...
!function (e, t, s) {
    ...
    Datepicker = function (e, a) {
        ...
        viewIndexes: ["days", "months", "years"], init: function () {
            ...
            this.$el.on(this.opts.showEvent + ".adp", this._onShowEvent.bind(this)), this.$el.on("blur.adp", this._onBlur.bind(this)), this.$el.on("input.adp", this._onInput.bind(this)), t(e).on("resize.adp", this._onResize.bind(this))
        }, _bindKeyboardEvents: function () {
            this.$el.on("keydown.adp", this._onKeyDown.bind(this)), this.$el.on("keyup.adp", this._onKeyUp.bind(this)), this.$el.on("hotKey.adp", this._onHotKey.bind(this))
        }, isWeekend: function (e) {
            return -1 !== this.opts.weekends.indexOf(e)
        }, _defineLocale: function (e) {
            "string" == typeof e ? (this.loc = Datepicker.language[e], this.loc || (console.warn("Can't find language \"" + e + '" in Datepicker.language, will use "ru" instead'), this.loc = t.extend(!0, {}, Datepicker.language.ru)), this.loc = t.extend(!0, {}, Datepicker.language.ru, Datepicker.language[e])) : this.loc = t.extend(!0, {}, Datepicker.language.ru, e), this.opts.dateFormat && (this.loc.dateFormat = this.opts.dateFormat), "" !== this.opts.firstDay && (this.loc.firstDay = this.opts.firstDay)
        }, _buildDatepickersContainer: function () {
            r = !0, i.append('<div class="datepickers-container" id="datepickers-container"></div>'), a = t("#datepickers-container")
        }, _buildBaseHtml: function () {
            var e, s = t('<div class="datepicker-inline">');
            e = "INPUT" == this.el.nodeName ? this.opts.inline ? s.insertAfter(this.$el) : a : s.appendTo(this.$el), this.$datepicker = t(c).appendTo(e), this.$content = t(".datepicker--content", this.$datepicker), this.$nav = t(".datepicker--nav", this.$datepicker)
            ...
            t = t || this.date;
            var s = e, i = this.loc, a = n.getDecade(t), h = n.getParsedDate(t);
            switch (!0) {
                case/@/.test(s):
            ...
            var t = this, s = t.opts, i = t.parsedDate, a = t.selectedDates, n = a.length, h = "";
            if (e instanceof Date) {
                if ("days" == t.view && e.getMonth() != i.month && s.moveToOtherMonthsOnSelect && (h = new Date(e.getFullYear(), e.getMonth(), 1)), "years" == t.view && e.getFullYear() != i.year && s.moveToOtherYearsOnSelect && (h = new Date(e.getFullYear(), 0, 1)), h && (t.silent = !0, t.date = h, t.silent = !1, t.nav._render()), s.multipleDates && !s.range) {
                    if (n === s.multipleDates)return;
                    t._isSelected(e) || t.selectedDates.push(e)
                } else s.range ? 2 == n ? (t.selectedDates = [e], t.minRange = e, t.maxRange = "") : 1 == n ? (t.selectedDates.push(e), t.maxRange ? t.minRange = e : t.maxRange = e, t.selectedDates = [t.minRange, t.maxRange]) : (t.selectedDates = [e], t.minRange = e) : t.selectedDates = [e];
                t._setInputValue(), s.onSelect && t._triggerOnChange(), s.autoClose && (s.multipleDates || s.range ? s.range && 2 == t.selectedDates.length && t.hide() : t.hide()), t.views[this.currentView]._render()
            }
        }, removeDate: function (e) {
            var t = this.selectedDates, s = this;
            if (e instanceof Date)return t.some(function (i, a) {
                return n.isSame(i, e) ? (t.splice(a, 1), s.selectedDates.length || (s.minRange = "", s.maxRange = ""), s.views[s.currentView]._render(), s._setInputValue(), s.opts.onSelect && s._triggerOnChange(), !0) : void 0
            })
        }, today: function () {
            ...
            return this.selectedDates.some(function (s) {
                return n.isSame(s, e, t)
            })
        }, _setInputValue: function () {
            var e, t = this, s = t.opts, i = t.loc.dateFormat, a = s.altFieldDateFormat, n = t.selectedDates.map(function (e) {
                return t.formatDate(i, e)
            });
            s.altField && t.$altField.length && (e = this.selectedDates.map(function (e) {
            ...
            var s = e.getTime(), i = n.getParsedDate(e), a = n.getParsedDate(this.minDate), h = n.getParsedDate(this.maxDate), o = new Date(i.year, i.month, a.date).getTime(), r = new Date(i.year, i.month, h.date).getTime(), c = {
            ...
            var t = this.parsedDate, i = e.data("year") || t.year, a = e.data("month") == s ? t.month : e.data("month"), n = e.data("date") || 1;
            return new Date(i, a, n)
        }, _setPositionClasses: function (e) {
            e = e.split(" ");
            var t = e[0], s = e[1], i = "datepicker -" + t + "-" + s + "- -from-" + t + "-";
            this.visible && (i += " active"), this.$datepicker.removeAttr("class").addClass(i)
        }, setPosition: function (e) {
            e = e || this.opts.position;
            var t, s, i = this._getDimensions(this.$el), a = this._getDimensions(this.$datepicker), n = e.split(" "), h = this.opts.offset, o = n[0], r = n[1];
            switch (o) {
                case"top":
                    t = i.top - a.height - h;
                    break;
            ...
            switch (r) {
                ...
                case"right":
                    ...
                    break;
                case"bottom":
                    t = i.top + i.height - a.height;
                    break;
                case"left":
                    s = i.left;
                    break;
                case"center":
                    /left|right/.test(o) ? t = i.top + i.height / 2 - a.height / 2 : s = i.left + i.width / 2 - a.width / 2
            }
            this.$datepicker.css({left: s, top: t})
        }, show: function () {
            ...
            var s = "up" == t ? this.viewIndex + 1 : this.viewIndex - 1;
            s > 2 && (s = 2), 0 > s && (s = 0), this.silent = !0, this.date = new Date(e.getFullYear(), e.getMonth(), 1), this.silent = !1, this.view = this.viewIndexes[s]
        }, _handleHotKey: function (e) {
            var t, s, i, a = n.getParsedDate(this._getFocusedDate()), h = this.opts, o = !1, r = !1, c = !1, d = a.year, l = a.month, u = a.date;
            switch (e) {
                case"ctrlRight":
                case"ctrlUp":
                    l += 1, o = !0;
            ...
            var e, t = !1, s = this, i = this.keys.sort();
            for (var a in l)e = l[a], i.length == e.length && e.every(function (e, t) {
                return e == i[t]
            }) && (s._trigger("hotKey", a), t = !0);
            return t
            ...
            if (!this._isHotKeyPressed()) {
                switch (e) {
                    case 37:
                        "day" == t ? h -= 1 : "", "month" == t ? a -= 1 : "", "year" == t ? i -= 1 : "";
                        break;
                    case 38:
                        "day" == t ? h -= 7 : "", "month" == t ? a -= 3 : "", "year" == t ? i -= 4 : "";
                        break;
                    case 39:
                        "day" == t ? h += 1 : "", "month" == t ? a += 1 : "", "year" == t ? i += 1 : "";
                        break;
            ...
            t = t || this.cellType;
            var s, i = n.getParsedDate(e), a = '.datepicker--cell[data-year="' + i.year + '"]';
            switch (t) {
                case"month":
            ...
            var s = t(e.target).closest(".datepicker--cell"), i = this._getDateFromCell(s);
            ...
            var s = t(e.target).closest(".datepicker--cell");
            ...
            return this.viewIndex = this.viewIndexes.indexOf(e), this.viewIndex < 0 ? void 0 : (this.prevView = this.currentView, this.currentView = e, this.inited && (this.views[e] ? this.views[e]._render() : this.views[e] = new Datepicker.Body(this, e, this.opts), this.views[this.prevView].hide(), this.views[e].show(), this.nav._render(), this.opts.onChangeView && this.opts.onChangeView(e), this.elIsInput && this.visible && this.setPosition()), e)
        }, get view() {
        ...
        return e.replace(/#\{([\w]+)\}/g, function (e, s) {
            return t[s] || 0 === t[s] ? t[s] : void 0
        })
    }, n.isSame = function (e, t, s) {
        if (!e || !t)return !1;
        var i = n.getParsedDate(e), a = n.getParsedDate(t), h = s ? s : "day", o = {
            day: i.date == a.date && i.month == a.month && i.year == a.year,
            month: i.month == a.month && i.year == a.year,
            year: i.year == a.year
        };
        return o[h]
    }, n.less = function (e, t, s) {
        return e && t ? t.getTime() < e.getTime() : !1
    }, n.bigger = function (e, t, s) {
        return e && t ? t.getTime() > e.getTime() : !1
    }, Datepicker.language = {
        ru: {
        ...
        return this.each(function () {
            if (t.data(this, h)) {
                var s = t.data(this, h);
                s.opts = t.extend(!0, s.opts, e), s.update()
            } else t.data(this, h, new Datepicker(this, e))
        })
    }, t(function () {
        t(o).datepicker()
    })
    ...
    t.Body = function (e, t, s) {
        this.d = e, this.type = t, this.opts = s, this.init()
    }, t.Body.prototype = {
        init: function () {
        ...
        }, _getDayNamesHtml: function (e, t, s, i) {
            return t = void 0 != t ? t : e, s = s ? s : "", i = void 0 != i ? i : 0, i > 7 ? s : 7 == t ? this._getDayNamesHtml(e, 0, s, ++i) : (s += '<div class="datepicker--day-name' + (this.d.isWeekend(t) ? " -weekend-" : "") + '">' + this.d.loc.daysMin[t] + "</div>", this._getDayNamesHtml(e, ++t, s, ++i))
        }, _getCellContents: function (e, s) {
            var i = "datepicker--cell datepicker--cell-" + s, a = new Date, n = this.d, h = n.opts, o = t.getParsedDate(e), r = {}, c = o.date;
            switch (h.onRenderCell && (r = h.onRenderCell(e, s) || {}, c = r.html ? r.html : c, i += r.classes ? " " + r.classes : ""), s) {
                case"day":
                ...
                case"year":
                    var d = n.curDecade;
                    c = o.year, (o.year < d[0] || o.year > d[1]) && (i += " -other-decade-", h.selectOtherYears || (i += " -disabled-"), h.showOtherYears || (c = ""))
            }
            return h.onRenderCell && (r = h.onRenderCell(e, s) || {}, c = r.html ? r.html : c, i += r.classes ? " " + r.classes : ""), h.range && (t.isSame(n.minRange, e, s) && (i += " -range-from-"), t.isSame(n.maxRange, e, s) && (i += " -range-to-"), 1 == n.selectedDates.length && n.focused ? ((t.bigger(n.minRange, e) && t.less(n.focused, e) || t.less(n.maxRange, e) && t.bigger(n.focused, e)) && (i += " -in-range-"), t.less(n.maxRange, e) && t.isSame(n.focused, e) && (i += " -range-from-"), t.bigger(n.minRange, e) && t.isSame(n.focused, e) && (i += " -range-to-")) : 2 == n.selectedDates.length && t.bigger(n.minRange, e) && t.less(n.maxRange, e) && (i += " -in-range-")), t.isSame(a, e, s) && (i += " -current-"), n.focused && t.isSame(e, n.focused, s) && (i += " -focus-"), n._isSelected(e, s) && (i += " -selected-"), (!n._isInRange(e, s) || r.disabled) && (i += " -disabled-"), {
                html: c,
                classes: i
            }
        }, _getDaysHtml: function (e) {
            var s = t.getDaysCount(e), i = new Date(e.getFullYear(), e.getMonth(), 1).getDay(), a = new Date(e.getFullYear(), e.getMonth(), s).getDay(), n = i - this.d.loc.firstDay, h = 6 - a + this.d.loc.firstDay;
            n = 0 > n ? n + 7 : n, h = h > 6 ? h - 7 : h;
            for (var o, r, c = -n + 1, d = "", l = c, u = s + h; u >= l; l++)r = e.getFullYear(), o = e.getMonth(), d += this._getDayHtml(new Date(r, o, l));
            return d
            ...
            for (var s = "", i = t.getParsedDate(e), a = 0; 12 > a;)s += this._getMonthHtml(new Date(i.year, a)), a++;
            return s
            ...
            var s = (t.getParsedDate(e), t.getDecade(e)), i = s[0] - 1, a = "", n = i;
            ...
            var e, t, s, i = $(".datepicker--cell", this.$cells), a = this;
            i.each(function (i, n) {
                t = $(this), s = a.d._getDateFromCell($(this)), e = a._getCellContents(s, a.d.cellType), t.attr("class", e.classes)
            })
        }, show: function () {
            ...
            var t = e.data("date") || 1, s = e.data("month") || 0, i = e.data("year") || this.d.parsedDate.year;
            if (this.d.view != this.opts.minView)return void this.d.down(new Date(i, s, t));
            var a = new Date(i, s, t), n = this.d._isSelected(a, this.d.cellType);
    ...
    var e = '<div class="datepicker--nav-action" data-action="prev">#{prevHtml}</div><div class="datepicker--nav-title">#{title}</div><div class="datepicker--nav-action" data-action="next">#{nextHtml}</div>', t = '<div class="datepicker--buttons"></div>', s = '<span class="datepicker--button" data-action="#{action}">#{label}</span>';
    Datepicker.Navigation = function (e, t) {
        ...
        init: function () {
            ...
            var t = this._getTitle(this.d.currentDate), s = Datepicker.template(e, $.extend({title: t}, this.opts));
            ...
            var t = {action: e, label: this.d.loc[e]}, i = Datepicker.template(s, t);
            $("[data-action=" + e + "]", this.$buttonsContainer).length || this.$buttonsContainer.append(i)
        }, _addButtonsContainer: function () {
            this.d.$datepicker.append(t), this.$buttonsContainer = $(".datepicker--buttons", this.d.$datepicker)
        }, setNavStatus: function () {
            if ((this.opts.minDate || this.opts.maxDate) && this.opts.disableNavWhenOutOfRange) {
                var e = this.d.parsedDate, t = e.month, s = e.year, i = e.date;
                switch (this.d.view) {
                    case"days":
                        this.d._isInRange(new Date(s, t - 1, i), "month") || this._disableNav("prev"), this.d._isInRange(new Date(s, t + 1, i), "month") || this._disableNav("next");
                        break;
                    case"months":
                        this.d._isInRange(new Date(s - 1, t, i), "year") || this._disableNav("prev"), this.d._isInRange(new Date(s + 1, t, i), "year") || this._disableNav("next");
                        break;
                    case"years":
                        this.d._isInRange(new Date(s - 10, t, i), "year") || this._disableNav("prev"), this.d._isInRange(new Date(s + 10, t, i), "year") || this._disableNav("next")
                }
            }
            ...
            var t = $(e.target).closest("[data-action]"), s = t.data("action");
            this.d[s]()
